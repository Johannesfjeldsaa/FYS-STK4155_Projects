...
def GD(X, y, initial_step, max_iter, tol, lambd=None, regression_method=None, momentum=None, optimization=None, rho1=None, rho2=None):
    ...
    MSE_scores = []  #score MSE scores for every iteration
...
def SGD(X, y, batch_size, n_epochs, initial_step, momentum, tol, regression_method=None,
        lmbd=None, optimization=None, rho1=0.9, rho2=0.99):
    ...
    MSE_scores = []  # store mse scores for each update
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        for i in range(num_batch):
            ...
            beta += change_vector
            MSE_scores.append(np.sum((y_batch - X_batch @ beta) ** 2) / batch_size)

    return beta, MSE_scores  #returning the optimal beta from the optimization method used, MSE_scores for each iteration. to make convergence plots
