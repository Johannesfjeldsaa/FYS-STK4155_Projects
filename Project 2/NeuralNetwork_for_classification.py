...
"""
modified to take cost function and get ready for classification
"""
...
class Dense_Layer:
    ...
    def forward_propagation(self, inputs):
        ...
        """
        self.output_pre_activation = jnp.dot(inputs, self.weights) + self.biases  # vil denne lage en liste, eller kun endre tallet?
...
class Neural_Network:
    ...
    def __init__(self, X, target, n_hidden_layers, n_hidden_nodes, n_outputs, cost_func,
